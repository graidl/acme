...
class MCTS(agent.Agent):
    ...
    def __init__(
        ...
        :param n_step: 1 for one-step temporal difference learning (TD(1)), otherwise a large enough value to
            exceed episode length for learning based on final episode reward
        """
        extra_spec = {
